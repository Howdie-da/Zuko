...
import { getStats, logoutHandle } from '../services/authService.js'
...
function Stats() {
  ...
  if (isLoading) {
    return (
      <div className="w-full min-h-svh flex items-center justify-center bg-transparent text-[#A46A44] font-mono text-xs tracking-widest animate-pulse">
